...
const ResizableWrapper = () => {
    ...
    const dragElement = () => {
        ...
        const elementDrag = (e) => {
            ...
            resizableEl.current.style.top = (resizableEl.current.offsetTop - secondPosition) + "px";
            resizableEl.current.style.left = (resizableEl.current.offsetLeft - firstPosition) + "px";
        }
